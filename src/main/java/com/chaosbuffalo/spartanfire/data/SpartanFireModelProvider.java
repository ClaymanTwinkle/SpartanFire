...
//        // TODO materials.add("dragonsteel_lightning");
//
...
//                .parent(getExistingFile(mcLoc("spartanweaponry:item/standard_item")))
...
//                .texture("0", modLoc("item/witherbone_pole"));
    ...
    private void makeMeleeModel(String weapon, String material) {
        ...
        getBuilder(path)
                .parent(getExistingFile(mcLoc("spartanweaponry:item/" + weapon + "_wood")))
    ...
    private void makeRangedModel(String weapon, String material) {
        ...
        getBuilder(path + "_firing")
                .parent(getExistingFile(mcLoc("spartanweaponry:item/" + weapon + "_wood_pulling_0")))
