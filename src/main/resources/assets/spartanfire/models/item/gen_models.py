...
mat_names = [('dragonbone', 'dragonbone'), ('dragonbone_fire', 'dragonbone_fire'), ('dragon_ice', 'dragon_ice'), ('dragonbone_lightning', 'dragonbone_lightning'), ('dragonsteel_lightning', 'dragonsteel_lightning')]

mat_names = [('dragonbone_lightning', 'dragonbone_lightning'), ('dragonsteel_lightning', 'dragonsteel_lightning')]

def gen_simple_item_model(mat_name, weapon_name, mod_name, texture_name):
    gen_dict = {
        "parent":"spartanweaponry:item/" + weapon_name + "_wood",
        "textures": {
            "layer0": mod_name + ":item/" + weapon_name + "_" + texture_name
        }
    }
...
def gen_pulling(mat_name, weapon_name, mod_name, texture_name, pull_count, base_pull):
    gen_dict = {
        ...
        "textures": {
            "layer0": mod_name + ":item/" + weapon_name + "_" + texture_name + "_pulling_" + pull_count
        }
    }
...
def gen_firing(mat_name, weapon_name, mod_name, texture_name):
    gen_dict = {
        ...
        "textures": {
            "layer0": mod_name + ":item/" + weapon_name + "_" + texture_name + "_loaded"
        }
    }
...
def gen_heavy_crossbow(mat_name, mod_name, texture_name):
    gen_pulling(mat_name, "heavy_crossbow", mod_name, texture_name, "0", "0")
    gen_pulling(mat_name, "heavy_crossbow", mod_name, texture_name, "1", "0")
    gen_pulling(mat_name, "heavy_crossbow", mod_name, texture_name, "2", "0")
    gen_firing(mat_name, "heavy_crossbow", mod_name, texture_name)
    gen_loaded(mat_name, "heavy_crossbow", mod_name, texture_name)
    gen_dict = {
        "parent": "spartanweaponry:item/heavy_crossbow_wood",
        "textures": {
            "layer0": mod_name + ":item/heavy_crossbow_" + texture_name + "_standby"
        },
        "overrides": [
            {
                "predicate": {
                ...
                "model": mod_name + ":item/heavy_crossbow_" + mat_name + "_pulling_0"
            },
            {
                "predicate": {
                    "pulling": 1,
                ...
                "model": mod_name + ":item/heavy_crossbow_" + mat_name + "_pulling_1"
            },
            {
                "predicate": {
                    "pulling": 1,
                ...
                "model": mod_name + ":item/heavy_crossbow_" + mat_name + "_pulling_2"
            },
            {
                "predicate": {
                    "pulling": 0,
                ...
                "model": mod_name + ":item/heavy_crossbow_" + mat_name + "_loaded"
            },
            {
                "predicate": {
                    "pulling": 1,
                ...
                "model": mod_name + ":item/heavy_crossbow_" + mat_name + "_firing"
            }
      ]
    }
    with open('heavy_crossbow_' + mat_name + '.json', 'w') as outfile:
        json.dump(gen_dict, outfile)
...
def gen_longbow(mat_name, mod_name, texture_name):
    ...
    "parent": "spartanweaponry:item/longbow_wood",
        "textures": {
            "layer0": mod_name + ":item/longbow_" + texture_name + "_standby"
        },
        "overrides": [
            {
              "predicate": {
...
for mat_name, texture_name in mat_names:
    ...
    gen_simple_item_model(mat_name, "tomahawk", MOD_NAME, texture_name)
    ...
    gen_simple_item_model(mat_name, "flanged_mace", MOD_NAME, texture_name)
    gen_simple_item_model(mat_name, "quarterstaff", MOD_NAME, texture_name)
    gen_simple_item_model(mat_name, "glaive", MOD_NAME, texture_name)

gen_longbow(mat_name, MOD_NAME, texture_name)
    gen_heavy_crossbow(mat_name, MOD_NAME, texture_name)
